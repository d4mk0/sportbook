        ...
        <?php
          ...
          while ($row = mysql_fetch_array($result)) {
            ...
            <div class='message'>
              ...
              <a href='blocks/delete_chat_message.php?id=%s'>Удалить</a>
            </div>
            ", $row['user_id'], $row['lastname'], $row['firstname'], $row['login'], date("d/m/Y H:i", strtotime($row['created_at'])), $row['text'], $row['id']);
          }
